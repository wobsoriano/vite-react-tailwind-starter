            ...
            <div className="flex-1 overflow-auto focus:outline-none">
                ...
                <div className="flex-1 overflow-auto focus:outline-none max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="relative flex items-center justify-between max-w-8xl mx-auto py-2 mt-8 px-4 text-lg leading-6 font-medium text-gray-900 sm:px-10 lg:px-4 xl:px-4">
                        <span className="pr-3 text-lg font-medium text-gray-900">Add Promotion</span>
                        <a
                            href="#"
                        >
                            <button
                    ...
                    <div className="pt-2 p-4 max-w-8xl">
                        ...
                        <div className="relative flex items-center justify-end max-w-8xl mx-auto py-2 mt-8 px-4 text-lg leading-6 font-medium text-gray-900 ">
                            <a
                                href="#"
                            >
                                <button
                                    type="button"
                                    className="inline-flex items-center shadow-sm px-4 py-2 mr-4 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-600 bg-gray-200 hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                >
                                    {/* <PlusSmIcon className="-ml-1.5 mr-1 h-5 w-5 text-white" aria-hidden="true" /> */}
                                    <span>Cancel</span>
                                </button>
