...
const transactions = [
    ...
    {
        id: 3,
        name: 'Zoom Alphafly Flyknit, Q3/21 - 001',
        href: '#',
        amount: '$260',
        currency: 'USD',
        status: 'Scheduled',
    ...
    {
        id: 6,
        name: 'Space Hippie 04, Q3/21 - 001',
        href: '#',
        amount: '$200',
        currency: 'USD',
        status: 'Inactive',
                ...
                <main className="flex-1 relative pb-8 z-0 overflow-y-auto">
                    ...
                    <div className="mt-8">
                        <div className="relative">
                            <div className="relative flex items-center justify-between max-w-7xl mx-auto py-2 mt-8 px-4 text-lg leading-6 font-medium text-gray-900 sm:px-6 lg:px-8 xl:px-24">
                                <span className="pr-3 text-lg font-medium text-gray-900">Promotions</span>
                                <a
                          href="/AddPromotion"
                        >
                                <button
