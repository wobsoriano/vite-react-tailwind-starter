                ...
                <main className="flex-1 relative pb-8 z-0 overflow-y-auto">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="relative flex justify-between max-w-6xl mx-auto py-2 mt-8 px-4 text-lg leading-6 font-medium text-gray-900 sm:px-6 lg:px-8 xl:px-8">
                            <span className="pr-3 text-lg font-medium text-gray-900">Select Product</span>
                            <button
                                type="button"
                                className="inline-flex items-center shadow-sm px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                            >
                                                ...
                                                <span className="flex-1 flex space-x-2 truncate">
                                                    ...
                                                    <div className="flex items-center rounded-lg">
                                                        <a href={transaction.href} className="group inline-flex space-x-8 truncate text-sm">
                                                            <div className="flex-shrink-0 h-16 w-16 items-center">
                                                                <img className="h-16 w-16 rounded-sm" src={transaction.image} alt="" />
                                                            </div>
                                                        </a>
                                                    </div>
