...
const product = {
    ...
    href: '#',
    imageSrc: 'https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/6eebe93e-067a-4caf-b51e-b4b9583b3c2c/air-zoom-alphafly-next-mens-racing-shoes-fNntgL.png',
    imageSrc2: 'https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/6eebe93e-067a-4caf-b51e-b4b9583b3c2c/air-zoom-alphafly-next-mens-racing-shoes-fNntgL.png',
    ...
    return (
        <div className="select-none">
                                                ...
                                                <section aria-labelledby="options-heading" className="mt-6">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div className="mt-2 select-none">
                                                            <div className="select-none">
                                                                <p className="text-xs text-gray-400 select-none">Description</p>
                                                            </div>
            ...
            <div className="w-full h-screen">
                <header className="bg-white z-50 flex">
                ...
                </header><main className="flex justify-center items-center">
                    <div className="bg-white">
                        <div className="max-w-7xl mx-auto overflow-hidden sm:px-6 lg:px-8">
                            ...
                            >
                                <div className="-mx-px border-l border-gray-200 grid grid-cols-2 sm:mx-0 md:grid-cols-3 lg:grid-cols-4 pt-2 mt-16 mb-20">
...
/>
                                                    ...
                                                    <p className="mt-1 text-xs text-gray-500">{product.promoType}</p>
                                                </div>
                                                <div className="inline-flex justify-between bg-gray-50 rounded-md items-center mt-2">
                                                    <p className="mx-1 text-xs font-medium text-gray-400 line-through">{product.price}</p>
                                                    <p className="mx-2 text-xs font-medium text-gray-900">{product.discountPrice}</p>
                                                    <p className="px-2 text-xs bg-green-50 p-1 font-medium rounded-md text-green-700">{product.comission}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                ...
                </main><div className="bottomNav fixed bottom-0 w-full border b-top z-50 webkit-tap-none">
                    <nav className="md:hidden bottom-0 w-full bg-white text-xs pb-2 webkit-tap-none">
                        <ul className="flex mx-auto justify-between items-center text-white text-center opacity-75 text-xs w-full webkit-tap-none">
                            {links.map((link, i) => (
                                <div className={`text-xs font-medium rounded-md p-1 items-center w-full mx-1 mb-4 mt-1 webkit-tap-none ${location.pathname === link.to
                                    ? activeClass
                                    : inactiveClass
                                    }`}
                                >
                                    <Link
                                        key={link.text}
                                        to={link.to}
                                        className="webkit-tap-none"
                                    >

                                        <li className="p-0 items-center webkit-tap-none">
                                            <div className="rounded-md items-center webkit-tap-none">
                            ...
                            {/* <a href="/AppPromo" className="w-full">
                                <li className="p-2">
                            ...
                            <a href="/AppSales" className="w-full">
                                <li className="p-2">
                                    <div className="p-1 rounded-md">
                            ...
                            <a href="/AppRank" className="w-full">
                                <li className="p-2">
                                    <div className="p-1 rounded-md">
